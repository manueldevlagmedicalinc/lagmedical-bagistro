...
class LagMedicalDemoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::transaction(function () {
            ...
            $this->seedFamilies();
            $this->seedProducts();
            $this->syncChannelLocalesAndRoot();
        });
    }
    ...
    private function syncChannelLocalesAndRoot(): void
    {
        ...
        foreach ($channels as $channelId) {
            DB::table('channels')->where('id', $channelId)->update(['root_category_id' => 1]);
