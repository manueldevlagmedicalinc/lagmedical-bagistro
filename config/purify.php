    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,a[href|title],ul,ol,li,p[style],br,span[style],div[class|style],img[width|height|alt|src],blockquote,table[class|style|width|border|cellpadding|cellspacing],thead[class],tbody[class],tr[class],td[class|style|colspan|rowspan|width],th[class|style|colspan|rowspan|width]',
