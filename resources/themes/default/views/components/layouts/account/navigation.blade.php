                ...
                <div class="grid rounded-md border border-b border-l-[1px] border-r border-t-0 border-zinc-200 max-md:border-none">
                    @foreach ($menuItem->getChildren() as $subMenuItem)
                        ...
                        <a href="{{ $subMenuItem->getUrl() }}">
                            <div class="flex cursor-pointer justify-between border-t border-zinc-200 px-6 py-5 hover:bg-zinc-100 max-md:border-0 max-md:px-0 max-md:py-3 max-md:p-4 {{ $subMenuItem->isActive() ? 'bg-zinc-100' : '' }}">
