...
<x-shop::layouts>
    ...
    @if ($category->banner_path)
        <div class="mx-auto mt-8 w-[90%] max-w-none px-[60px] max-lg:w-full max-lg:px-8 max-md:mt-4 max-md:px-4">
    ...
    @if (in_array($category->display_mode, [null, 'description_only', 'products_and_description']))
        @if ($category->description)
            <div class="mx-auto mt-[34px] w-[90%] max-w-none px-[60px] max-lg:w-full max-lg:px-8 max-md:mt-4 max-md:px-4 max-md:text-sm max-sm:text-xs">
    ...
    @pushOnce('scripts')
        ...
        >
            <div class="mx-auto w-[90%] max-w-none px-[60px] max-lg:w-full max-lg:px-8 max-md:px-4">
