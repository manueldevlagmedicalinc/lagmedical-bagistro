        ...
        app.component('v-filters', {
            ...
            data() {
                return {
                    ...
                    isPriceHidden: @json(lagmedical_hide_prices()),
            ...
            computed: {
                visibleFilters() {
                    if (! Array.isArray(this.filters.available)) {
            ...
            methods: {
                ...
                applyFilter(filter, values) {
                    if (this.isPriceHidden && filter.type === 'price') {
                ...
                clear() {
                     ...
                     */
                    if (Array.isArray(this.$refs.filterItemComponent)) {
