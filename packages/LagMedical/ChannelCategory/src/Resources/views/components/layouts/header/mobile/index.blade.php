                ...
                <div class="py-4">
                        ...
                        <div class="flex items-center justify-between py-2 transition-colors duration-200 cursor-pointer">
                            <a :href="category.url" class="text-base font-medium text-black">
                                @{{ category.raw_name || category.name }} <small>(@{{ category.total_products || 0 }})</small>
                            </a>
                        </div>
                            ...
                            <div v-if="category.children && category.children.length" >
                                ...
                                >
                                    ...
                                    <a :href="secondLevelCategory.url" class="text-sm font-normal">
                                        @{{ secondLevelCategory.raw_name || secondLevelCategory.name }} <small>(@{{ secondLevelCategory.total_products || 0 }})</small>
                                    </a>
            ...
            <!-- Third level view -->
                ...
                <div class="px-6 py-4">
                        ...
                        >
                            ...
                            >
                            @{{ thirdLevelCategory.raw_name || thirdLevelCategory.name }} <small>(@{{ thirdLevelCategory.total_products || 0 }})</small>
                        </a>
                    </div>
                </div>
            </div>
